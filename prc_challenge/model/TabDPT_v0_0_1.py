...
class TabDPT_v0_0_1(object):
    ...
    def fit(self, X, y, column_functions):
        ...
        self.columns_to_use = column_functions["numerical"]+column_functions["categorical"]
        self.model = TabDPTRegressor(**self.kwargs)
        self.model.fit(X[self.columns_to_use].to_numpy(), y.to_numpy())
    ...
    def predict(self, X):
        ...
        return self.model.predict(X[self.columns_to_use].to_numpy(), **self.predict_kwargs)
