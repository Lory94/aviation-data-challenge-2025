...
def add_additionnal_feats_to_df(FuelSegment_X: pd.DataFrame, FuelSegment_Y: pd.DataFrame, FlightList: pd.DataFrame, Airport, Flight):
    """
    ...
    # 1. Prepare 'aircraft_type' for mapping/joining.
    FlightList['aircraft_type'] = FlightList['aircraft_type'].str.upper()
...
if __name__ == '__main__':
    ...
    df_feats_added, _, _, _, _ = add_additionnal_feats_to_df(FuelSegment_X, pd.DataFrame, Flightlist, "airport", "flight")
