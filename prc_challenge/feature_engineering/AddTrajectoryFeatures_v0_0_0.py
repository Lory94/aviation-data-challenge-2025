...
class AddTrajectoryFeatures_v0_0_0(BaseFeatureEngineering):
    ...
    def __call__(
        ...
        all_new_cols = agg_features_cols + delta_features_cols

        # 2. Prepare FuelSegment_X with a temporary ID for later merging
        ...
        for fid in unique_flight_ids:
            ...
            # Combine for this flight and add to list
            combined_flight_features = pd.concat([agg_features, delta_features], axis=1)
